...
namespace UniversalTennis.Algorithm.Migrations
{
    ...
    [Migration("20171205214755_Update_SubRating_Table")]
    partial class Update_SubRating_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniversalTennis.Algorithm.Models.PlayerRating", b =>
                {
                    ...
                    b.Property<double?>("InactiveRating");
            ...
            modelBuilder.Entity("UniversalTennis.Algorithm.Models.SubRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<double?>("ClayCourt");

                    b.Property<int?>("ClayCourtCount");

                    b.Property<DateTime>("DateCreated");

                    b.Property<DateTime>("DateLastUpdated");

                    b.Property<double?>("EightWeek");

                    b.Property<int?>("EightWeekCount");

                    b.Property<double?>("GrandSlamMasters");

                    b.Property<int?>("GrandSlamMastersCount");

                    b.Property<double?>("GrassCourt");

                    b.Property<int?>("GrassCourtCount");

                    b.Property<double?>("HardCourt");

                    b.Property<int?>("HardCourtCount");

                    b.Property<double?>("OneMonth");

                    b.Property<int?>("OneMonthCount");

                    b.Property<int>("PlayerRatingId");

                    b.Property<int?>("ResultCount");

                    b.Property<double?>("SixWeek");

                    b.Property<int?>("SixWeekCount");

                    b.Property<double?>("ThreeMonth");

                    b.Property<int?>("ThreeMonthCount");
            ...
            modelBuilder.Entity("UniversalTennis.Algorithm.Models.SubRating", b =>
                {
                    b.HasOne("UniversalTennis.Algorithm.Models.PlayerRating", "PlayerRating")
                        .WithOne("SubRating")
                        .HasForeignKey("UniversalTennis.Algorithm.Models.SubRating", "PlayerRatingId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
